...
public class TransferClaimCommand extends BaseCommand implements PlayerCommandExecutor
{
    ...
    public void run(Player player, CommandArguments arguments) throws WrapperCommandSyntaxException
    {
        ...
        if (claim == null)
        {
            GriefPrevention.sendMessage(player, TextMode.INSTRUCTION, Messages.TransferClaimMissing);
            return;
        }
        ...
        {
            GriefPrevention.sendMessage(player, TextMode.ERROR, Messages.TransferClaimPermission);
            return;
        }
        ...
        {
            GriefPrevention.sendMessage(player, TextMode.INSTRUCTION, Messages.TransferTopLevel);
            return;
        }
        ...
        GriefPrevention.AddLogEntry(player.getName() + " transferred a claim at " +
                                    ...
                                    " to " + target.getName() + ".", ActivityType.ADMIN);
    }
}
