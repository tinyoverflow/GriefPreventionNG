...
public class Visualization
{
     ...
     */
    @Deprecated(forRemoval = true, since = "16.18")
    public static Visualization FromClaim(Claim claim, int height, me.tinyoverflow.griefprevention.VisualizationType visualizationType, Location locality)
    {
     ...
     */
    @Deprecated(forRemoval = true, since = "16.18")
    public void addClaimElements(Claim claim, int height, me.tinyoverflow.griefprevention.VisualizationType visualizationType, Location locality)
    {
    ...
    public void addClaimElements(Location min, Location max, Location locality, int height, BlockData cornerBlockData, BlockData accentBlockData, int STEP) {
        this.boundaries.add(new Boundary(new BoundingBox(min, max), me.tinyoverflow.griefprevention.VisualizationType.ofBlockData(accentBlockData)));
    }
     ...
     */
    @Deprecated(forRemoval = true, since = "16.18")
    public static Visualization fromClaims(Iterable<Claim> claims, int height, me.tinyoverflow.griefprevention.VisualizationType type, Location locality)
    {
        Visualization visualization = new Visualization();
