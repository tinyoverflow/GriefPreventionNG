...
public class BlockIgniteListener implements Listener
{
    ...
    public void onBlockIgnite(BlockIgniteEvent igniteEvent)
    {
        ...
        if (igniteEvent.getCause() == BlockIgniteEvent.IgniteCause.LIGHTNING &&
            GriefPrevention.instance.dataStore.getClaimAt(
                    igniteEvent.getIgnitingEntity().getLocation(),
                    false,
                    null
            ) != null)
        {
        ...
        if (igniteEvent.getCause() == BlockIgniteEvent.IgniteCause.FIREBALL &&
            igniteEvent.getIgnitingEntity() instanceof Fireball)
        {
        ...
        if (igniteEvent.getCause() == BlockIgniteEvent.IgniteCause.ARROW && igniteEvent.getIgnitingEntity() != null) {
            ...
            if (blockData instanceof Lightable lightable) {
                ...
                // Call event.
                boolean isCancelled = new EntityChangeBlockEvent(
        ...
        if (!GriefPrevention.instance.config_fireSpreads &&
            igniteEvent.getCause() != BlockIgniteEvent.IgniteCause.FLINT_AND_STEEL &&
            igniteEvent.getCause() != BlockIgniteEvent.IgniteCause.LIGHTNING)
        {
            igniteEvent.setCancelled(true);
        }
    }
